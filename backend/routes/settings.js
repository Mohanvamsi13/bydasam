...
const imageStorage = new CloudinaryStorage({ cloudinary, params: { folder:'bydasam-about', allowed_formats:['jpg','jpeg','png','webp'], transformation:[{ width:800, crop:'limit', quality:'auto' }] } });
